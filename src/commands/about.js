...
export function cmdAbout() {
  return [
    ...
    // { type: 'br' },
    { type: 'cream', text: "I'm a third-year CS student at NSUT Delhi, specializing in AI. My work spans the full ML stack: from research-level model design to production deployment. I care about systems that actually ship and results you can measure." },
    { type: 'br' },
